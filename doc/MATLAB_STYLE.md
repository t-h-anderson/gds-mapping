...
Conventions for writing MATLAB across our projects. Distilled from `AppStatusStack` (modern reference), `eds-matlab`, and the MathWorks MATLAB Coding Guidelines v1.0 (2025-04-30). Where any of these diverge, the rules below win for our code.
