    ...
    methods (Test)
        function tDemoPipelineProducesExpectedMappings(testCase)
            ...
            writelines([ ...
                ...
                "explicit,100,ref2/in1,esca_special_override,override"; ...
                "regex,10,^ref(\d+)/in(\d+)$,esca_in_${1}_${2},"; ...
                "regex,10,^ref(\d+)/out(\d+)$,esca_out_${1}_${2},"; ...
                "regex,10,^meas/voltage/phase([ABC])$,MMXU1.PhV.phs${1}.cVal.mag.f,"; ...
                "regex,10,^meas/current/phase([ABC])$,MMXU1.A.phs${1}.cVal.mag.f,"; ...
                "regex,10,^status/breaker(\d+)$,XCBR${1}.Pos.stVal,"], ...
                "rules.csv");
