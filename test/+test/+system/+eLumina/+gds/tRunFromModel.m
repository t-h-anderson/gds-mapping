    ...
    methods (Test)
        function tDemoModelEndToEnd(testCase)
            ...
            writelines([ ...
                ...
                "regex,^Controllers/ctrl(\d+)/In1\.(\w+)$,esca_ctrl${1}_in_${2},"; ...
                "regex,^Controllers/ctrl(\d+)/In2\.(\w+)$,esca_ctrl${1}_param_${2},"; ...
                "regex,^Controllers/ctrl(\d+)/Out1\.(\w+)$,esca_ctrl${1}_out_${2},"], ...
                "rules.csv");
            ...
            testCase.verifyEqual( ...
                results(byPath("Controllers/ctrl1/In1.a")).IecPath.Path, ...
                "esca_ctrl1_in_a");
            testCase.verifyEqual( ...
                results(byPath("Controllers/ctrl2/Out1.a2")).IecPath.Path, ...
                "esca_ctrl2_out_a2");
            testCase.verifyEqual( ...
                results(byPath("Controllers/ctrl1/In2.p1")).IecPath.Path, ...
                "esca_ctrl1_param_p1");
